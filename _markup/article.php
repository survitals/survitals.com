...
<article class="hentry {{class}}" itemscope itemtype="http://schema.org/Article">
  <header class="entry-header">
    <h1 class="entry-title">
      <a rel="bookmark" itemprop="url" href="{{url}}"><span itemprop="name">{{title}}</span></a>
    </h1>
  </header>

  <div class="entry-content" itemprop="articleBody">{{item.html}}</div>
  ...
  <footer class="entry-footer" role="contentinfo">
    <dl class='pairs meta-list entry-meta'>
      ...
      <dd class='meta-value edit-value'><a href="{{url.edit}}" rel="nofollow">Edit this article.</a></dd>
    </dl>
  </footer>
</article>